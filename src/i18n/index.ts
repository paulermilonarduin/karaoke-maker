...
const frMessages = {
  ...
  'shortcut.action.markerCreate': 'Segmenter au curseur',
  'shortcut.action.markerInterlude': 'Ajouter un interlude',
  'shortcut.action.markerNudgeBackward': 'Décaler le bloc de -100 ms',
  'shortcut.action.markerNudgeForward': 'Décaler le bloc de +100 ms',
  'shortcut.action.markerUndo': 'Annuler la dernière action',
...
const enMessages: Record<keyof typeof frMessages, string> = {
  ...
  'shortcut.action.markerCreate': 'Split at cursor',
  'shortcut.action.markerInterlude': 'Add interlude',
  'shortcut.action.markerNudgeBackward': 'Nudge block by -100 ms',
  'shortcut.action.markerNudgeForward': 'Nudge block by +100 ms',
  'shortcut.action.markerUndo': 'Undo last action',
