...
const frMessages = {
  ...
  'generator.autoHint': 'Vous pourrez ajuster le résultat sur la waveform avant l’export.',
...
const enMessages: Record<keyof typeof frMessages, string> = {
  ...
  'generator.autoHint': 'You can fine-tune the result on the waveform before exporting.',
